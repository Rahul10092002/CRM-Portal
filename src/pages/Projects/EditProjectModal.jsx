...
function EditProjectModal({ project, onClose }) {
  ...
  const handleAmenityChange = (e) => {
    const amenitiesArr = e.target.value.split(",").map((a) => a.trim());
    setFormData((prev) => ({ ...prev, amenities: amenitiesArr }));
  };


    const addFloorPlan = () => {
        const newFloorPlan = { type: "", size: "", startingPrice: "", available: 0 };
        setFormData((prev) => ({
            ...prev,
  ...
  // Handle nested documents change
